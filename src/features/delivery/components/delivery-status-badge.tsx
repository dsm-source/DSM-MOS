...
const CLS: Record<DeliveryStatus, string> = {
  ...
  prepared: "bg-blue-500/15 text-blue-700 dark:text-blue-300 border-transparent",
  shipped: "bg-amber-500/15 text-amber-700 dark:text-amber-300 border-transparent",
